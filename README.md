...
Il vise à analyser les relations entre les **rappeurs américains**, en utilisant des techniques numériques et des données extraites de **Wikipédia**.  
...
## 🎯 Objectifs du projet  
- 📊 **Constituer une base de données** contenant au moins **100 rappeurs américains**.  
...
- [📌 Liste des rappeurs américains](https://fr.wikipedia.org/wiki/Cat%C3%A9gorie:Rappeur_am%C3%A9ricain)  
...
- [🎵 Labels de hip-hop américains](https://fr.wikipedia.org/wiki/Cat%C3%A9gorie:Label_de_hip-hop_ayant_son_si%C3%A8ge_aux_%C3%89tats-Unis)  
